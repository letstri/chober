 ...
 */
var Q=u.a;t.default=new function Chober(){c()(this,Chober),o()(this,{VERSION:Q,isEmpty:_,isArray:v,isNumber:f,isString:s,isObject:l,isBoolean:d,isEqual:S,isUndefined:w,getQuery:k,getNumbers:C,getScrollbarWidth:x,getCookie:E,getOffset:q,getType:a,setQuery:I,setCookie:U,removeCookie:R,decodeHtml:J,clone:j,invertObject:P,first:A,flattenDeep:T,formatNumber:D,debounce:M,scrollTo:H,uniq:N})}}])});